...
export const apIsDescription: INodeProperties[] = [
			...
			"options": [
				{
					"name": "Cocer",
					"value": "Cocer",
					"action": "Company Related Certificate",
					"description": "API to verify Company Related Certificate.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/cocer/certificate"
						}
					}
				},
				{
					"name": "Rfcer",
					"value": "Rfcer",
					"action": "Registration Certificate of Firm/ Company",
					"description": "API to verify Registration Certificate of Firm/ Company.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/rfcer/certificate"
						}
					}
				}
			],
		...
		{
			"displayName": "POST /cocer/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /rfcer/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
